...
<!--                            <td>--><?php //= htmlspecialchars($uebung['id']) ?><!--</td>-->
<!--                            <td><input type="text" name="name" value="--><?php //= htmlspecialchars($uebung['name']) ?><!--" required maxlength="40"></td>-->
<!--                            <td><input type="text" name="file_name" value="--><?php //= htmlspecialchars($uebung['file_name']) ?><!--" required disabled maxlength="40"></td>-->
<!--                            <td><input type="text" name="beschreibung" value="--><?php //= htmlspecialchars($uebung['beschreibung']) ?><!--" required maxlength="80"></td>-->
<!--                            <td><input type="text" name="symbol" value="--><?php //= htmlspecialchars($uebung['symbol']) ?><!--" maxlength="10"></td>-->
<!--                            <td>-->
<!--                                <select name="kachelfarbe" required>-->
<!--                                    <option value="blue"   --><?php //= ($uebung['kachelfarbe'] === 'blue'   ? 'selected' : '') ?><!-->Blau</option>-->
<!--                                    <option value="yellow" --><?php //= ($uebung['kachelfarbe'] === 'yellow' ? 'selected' : '') ?><!-->Gelb</option>-->
<!--                                    <option value="lila"   --><?php //= ($uebung['kachelfarbe'] === 'lila'   ? 'selected' : '') ?><!-->Lila</option>-->
<!--                                    <option value="green"  --><?php //= ($uebung['kachelfarbe'] === 'green'  ? 'selected' : '') ?><!-->Grün</option>-->
<!--                                    <option value="pink"   --><?php //= ($uebung['kachelfarbe'] === 'pink'   ? 'selected' : '') ?><!-->Pink</option>-->
<!--                                    <option value="red"    --><?php //= ($uebung['kachelfarbe'] === 'red'    ? 'selected' : '') ?><!-->Rot</option>-->
<!--                                    <option value="orange" --><?php //= ($uebung['kachelfarbe'] === 'orange' ? 'selected' : '') ?><!-->Orange</option>-->
<!--                                </select>-->
<!--                            </td>-->
<!--                            <td>-->
<!--                                <select name="fachID" required>-->
<!--                                    --><?php //foreach ($faecher as $fach): ?>
<!--                                        <option value="--><?php //= $fach['id'] ?><!--" --><?php //= ($uebung['fachID'] == $fach['id'] ? 'selected' : '') ?><!-->-->
<!--                                            --><?php //= htmlspecialchars($fach['name']) ?>
<!--                                        </option>-->
<!--                                    --><?php //endforeach; ?>
<!--                                </select>-->
<!--                            </td>-->
<!--                            <td>-->
<!--                                <input type="hidden" name="id" value="--><?php //= $uebung['id'] ?><!--">-->
<!--                                <input type="hidden" name="file_name" value="--><?php //= $uebung['file_name'] ?><!--">-->
...
<!--                    --><?php //foreach ($faecher as $fach): ?>
<!--                        <option value="--><?php //= $fach['id'] ?><!--">--><?php //= htmlspecialchars($fach['name']) ?><!--</option>-->
<!--                    --><?php //endforeach; ?>
<!--                </select>-->
<!---->
...
<!--                            <td>--><?php //= htmlspecialchars($uebung['id']) ?><!--</td>-->
<!--                            <td>--><?php //= htmlspecialchars($uebung['name']) ?><!--</td>-->
<!--                            <td>-->
...
<!--                                <input type="hidden" name="id" value="--><?php //= $uebung['id'] ?><!--">-->
<!--                                <input type="hidden" name="file_name" value="--><?php //= $uebung['file_name'] ?><!--">-->
<!--                                <input type="hidden" name="fachID" value="--><?php //= $uebung['fachID'] ?><!--">-->
<!--                                <input type="hidden" name="fach_dir" value="--><?php //= $fach_dir ?><!--">-->
