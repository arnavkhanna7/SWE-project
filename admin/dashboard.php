...
<main id="hauptinhalt">
    <section class="login-container" style="max-width: 800px; margin-top: 3rem; text-align: center;">
        ...
        <div class="grid" style="margin-bottom: 3rem; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
            ...
            <!-- Für Schühler accounts erstellen/löschen und verwalten-->
            <?php if ($user_role === 'lehrer'): ?>
                <a href="schueler_accounts/schueler_verwalten.php" class="tile" style="cursor: pointer;">
                    <div class="tile-icon">👩‍🎓</div>
                    <div class="tile-title">Schüler verwalten</div>
                    <p style="font-size: 0.9rem; color: var(--muted);">
                        Schüler anlegen & löschen
                    </p>
                </a>
            <?php endif; ?>
